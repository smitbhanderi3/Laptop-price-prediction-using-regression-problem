...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Smit\03) Project\laptop-Price-Prediction-Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Smit\03) Project\laptop-Price-Prediction-Project\Scripts\deactivate.nu'
